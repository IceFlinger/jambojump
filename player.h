...
#define PLAYER_AIR_GRAV 12 //10
#define PLAYER_WALL_GRAV 5 //7
...
#define PLAYER_SOFT_JUMP_SPEED -8 //-6
#define PLAYER_SOFT_JUMP_THRES 3 //9, between air grav and wall grav
